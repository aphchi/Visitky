$(document).ready(() => {
    ...
    let typeColor={
        ...
        "Цветная с лицевой, черно-белая c оборотной":{file:220, print: 51},
        "Двусторонняя цветная":{file:220, print: 74},
    };
    insertPaper();
     function insertPaper(){
        // <option value="Меловидная бумага">Мелованная бумага</option>
        let html="";
    ...
    insertColor();
     ...
     $(".calc").change(function(){
        ...
        $("#card_4_0").show("slow"); 
        if(color_format=="Цветная с лицевой, черно-белая c оборотной")
        $("#card_4_1").show("slow"); 
